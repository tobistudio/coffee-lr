...
// routes/api.checkout.remove-discount-code.ts

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../+types/root.js"

type Module = typeof import("../api.checkout.remove-discount-code.js")

export type Info = {
  parents: [Parent0],
  id: "routes/api.checkout.remove-discount-code"
  file: "routes/api.checkout.remove-discount-code.ts"
