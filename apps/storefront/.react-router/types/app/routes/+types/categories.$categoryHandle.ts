...
// routes/categories.$categoryHandle.tsx

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../+types/root.js"

type Module = typeof import("../categories.$categoryHandle.js")

export type Info = {
  parents: [Parent0],
  id: "routes/categories.$categoryHandle"
  file: "routes/categories.$categoryHandle.tsx"
  path: "categories/:categoryHandle"
  params: {"categoryHandle": string} & { [key: string]: string | undefined }
  module: Module
